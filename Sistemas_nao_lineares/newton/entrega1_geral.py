...
for idx, X_k in enumerate(chutes_iniciais):
    ...
    for i in range(max_iter):
        ...
        resultados.append([i, *X_k.round(5), *erro.round(5), round(np.max(erro), 5)])
    ...
    # Exibindo a tabela final para cada caso
    print(f"\nResultados para o Caso {chr(97 + idx)} (Chute Inicial: {chutes_iniciais[idx]})")
    print(df_resultados)
